	...
	<section class="avada-db-card fusion-white-label-option">
		<div class="fusion-white-label-option-title">
			...
			<p class="description">
				<?php
				// Translators: Avada.
				printf( __( 'Controls the menu icon image on %s admin menu and replaces the %s logo. <br/><strong>Recommended size:</strong> 20px wide x 20px high.', 'fusion-white-label-branding' ), 'Avada', 'Avada' ); // phpcs:ignore WordPress.Security.EscapeOutput
				?>
			</p>
		</div>
		<div class="fusion-white-label-option-input">
		...
		<div class="fusion-white-label-option-title">
			...
			<p class="description">
				...
				printf(
					...
					__( 'Controls the menu icon image on %s admin menu and replaces the ThemeFusion logo. <br/><strong>Recommended size:</strong> 20px wide x 20px high.', 'fusion-white-label-branding' ), // phpcs:ignore WordPress.Security.EscapeOutput
